    ...
    <>
      ...
      <div className="pageHeaderContainer">
        ...
        <div className="pageHeaderMenuPreHeader" id="PageMenuPreHeader">
          ...
          >
            <img id="logotoedits" src="https://res.cloudinary.com/drupytlml/image/upload/v1744979032/rrrjd9y1bsgaqq2wf2mq.png" alt="" width={100} />
          </a>
          ...
          <style
            ...
            dangerouslySetInnerHTML={{
              __html:
                '.mobileNewsletter{position:absolute;top:70px;left:62px}.menuicon{position:relative}.menuicon .indicator{position:absolute;top:-14px;right:-9px;border-radius:50%;background-color:#5bbccd;color:#fff;font-size:10px;height:12px;line-height:13px;text-indent:1px;white-space:nowrap;min-width:12px;text-align:center;font-family:"Lucida Console", Monaco, monospace;border:2px solid #fff;box-sizing:content-box}@media (min-width: 768px){.mobileNewsletter{display:none}.menuicon .indicator{top:-17px}}\n'
            }}
          />
